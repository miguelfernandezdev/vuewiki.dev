...
<template>
  <div class="footer-cta">
    <a :href="`${repoUrl}/issues/new`" target="_blank" rel="noreferrer" class="cta-card">
      <div class="cta-icon">
    ...
    <div class="cta-bar">
      <a :href="`${repoUrl}/blob/main/CONTRIBUTING.md`" target="_blank" rel="noreferrer" class="contribute-link">
