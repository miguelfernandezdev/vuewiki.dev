...
<img src="/diagrams/es/how-pinia-works.svg" alt="Diagrama de arquitectura de Pinia: defineStore crea state, getters y actions que los componentes acceden directamente" style="max-width: 100%;" />
