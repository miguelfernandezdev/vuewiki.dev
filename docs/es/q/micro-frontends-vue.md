...
<img src="/diagrams/es/micro-frontends-vue.svg" alt="Diagrama de arquitectura mostrando shell app con micro-frontends remotos via Module Federation" style="max-width: 100%;" />
