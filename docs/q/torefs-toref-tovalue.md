...
summary: "toRefs converts each reactive property into a ref (safe destructuring). toRef creates a single ref linked to one property. toValue unwraps refs/getters."
---
